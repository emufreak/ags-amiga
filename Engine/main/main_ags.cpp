...
namespace AGS { namespace Common { } namespace Engine { }  }

using namespace AGS::Common;
using namespace AGS::Engine;

char *appPath; // engine exe path
char appDirectory; // engine dir
char cmdGameDataPath; // game path received from cmdline
